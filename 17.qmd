...
Principal Component Analysis is a method to reduce the dimension of correlated variables by creating p linear combinations from p original variables. In this case, correlation-based PCA is used as the variation of standard deviation values.

```{r}
#| echo: false
#| warning: false
#| label: fig-barplot4
#| fig-cap: PCA components for Socio-economic features. The first PC can retain ~70% of variation.
#| fig-align: center
#| fig-width: 3
#| fig-height: 3
#| message: false
...
-   Perform PCA to socio-economic features, and replace them with first PC.
