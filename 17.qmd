...
KNN is a simple and effective classification algorithm suitable for this scenario. It's non-parametric and doesn't make any assumptions about the underlying data distribution. With a relatively large dataset like this (10,000 records), KNN can produce reasonable results without the need for complex tuning or parameter optimization.
...
So far, Random Forest is the best one.
